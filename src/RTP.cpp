...
ompl::geometric::RTP::RTP(const ompl::base::SpaceInformationPtr &si, bool addIntermediateStates) : ompl::base::Planner(si, addIntermediateStates ? "RRTintermediate" : "RRT") {
