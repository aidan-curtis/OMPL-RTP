...
def plotObstacles(ax):
    ...
    ax.add_patch(patches.Polygon([(-0.5,-2),(-0.4,-2),(-0.4,1.8),(-0.5,1.8)], fill=True, color='0.20'))
    ax.add_patch(patches.Polygon([(0.5,-1.8),(0.6,-1.8),(0.6,2),(0.5,2)], fill=True, color='0.20'))
